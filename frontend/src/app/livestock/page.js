...
export default function LivestockPage() {
  ...
  const fetchLivestock = async () => {
    try {
      setLoading(true)
      const res = await fetch(`https://agritrack-2.onrender.com/api/livestock`, {
        credentials: 'include'
      })
  ...
  const handleAddLivestock = async (livestockData) => {
   ...
   const handleDeleteLivestock = async (id) => {
        try {
            ...
            const res = await fetch(`https://agritrack-2.onrender.com/api/livestock/${id}`, {
            method: 'DELETE',
            credentials: 'include',
            headers: {
                'Content-Type': 'application/json'
  ...
  const handleAddFeedingLog = async (id, logData) => {
    try {
      const res = await fetch(`https://agritrack-2.onrender.com/api/livestock/${id}/feeding`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  try {
    const res = await fetch(`https://agritrack-2.onrender.com/api/livestock/${id}/vet`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
...
const handleAddVaccination = async (id, vaccineData) => {
  try {
    const res = await fetch(`https://agritrack-2.onrender.com/api/livestock/${id}/vaccinations`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
